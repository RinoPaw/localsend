        ...
        body: Builder(
          builder: (context) {
            ...
            return ResponsiveListView(
              ...
              children: [
                Text(
                  t.webSharePage.openLink(n: networkState.localIps.length),
