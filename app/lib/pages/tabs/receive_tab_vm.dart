...
final _showAdvancedProvider = StateProvider<bool>(
  (ref) => false,
  debugLabel: '_showAdvancedProvider',
);

/// Whether the history button is shown
/// This extra boolean is needed to delay the animation
final _showHistoryButtonProvider = StateProvider<bool>(
  (ref) => true,
...
final receiveTabVmProvider = ViewProvider((ref) {
  final (alias, quickSave, quickSaveFromFavorites) = ref.watch(
    settingsProvider.select(
      (s) => (s.alias, s.quickSave, s.quickSaveFromFavorites),
    ),
  );
